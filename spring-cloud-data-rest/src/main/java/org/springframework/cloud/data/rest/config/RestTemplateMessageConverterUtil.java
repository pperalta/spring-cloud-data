...
import org.springframework.cloud.data.rest.controller.AdminController;
...
public class RestTemplateMessageConverterUtil {
	...
	private static final Class<?>[] ourClasses = { PagedResources.class, AdminController.RootResource.class,
